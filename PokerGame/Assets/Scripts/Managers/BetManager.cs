...
public class BetManager : MonoBehaviour
{
    ...
    #region PotHandler Methods - Should seperate the class.
    ...
    public List<Pot> DevideIntoPots()
    {
        ...
        CheckIfAnyRemainderChipsShouldBeReturned();

        List<int> potDefiningBetValues = FindPotDefiningValues();

        List<Pot> pots = GeneratePots(potDefiningBetValues);

        SelectEligiblePlayersForPots(pots);

        GatherChipsInThePots(pots);

        pots = RemoveLastPotIfNeeded(pots);
    ...
    private void CheckIfAnyRemainderChipsShouldBeReturned()
    {
    ...
    private List<int> FindPotDefiningValues()
    {
        ...
        return potDefiningBetValues;
    }

    private List<Pot> GeneratePots(List<int> potDefiningBetValues)
    {
    ...
    private void SelectEligiblePlayersForPots(List<Pot> pots)
    {
    ...
    private void GatherChipsInThePots(List<Pot> pots)
    {
    ...
    private List<Pot> RemoveLastPotIfNeeded(List<Pot> pots)
    {
